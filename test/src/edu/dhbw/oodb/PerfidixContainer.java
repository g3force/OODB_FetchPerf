...
{
	final static String[]	classNames	= { "edu.dhbw.sos.gui.plan.data.TimeBlocksTest" };
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			File folder = new File(System.getProperty("user.home") + "/workspace/OODB_FetchPerf/benchmark/");
